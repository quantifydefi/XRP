...
export type AllProtocolsGqlQuery = {
  __typename?: 'Query'
  protocols: Array<{
    __typename?: 'Protocol'
    id: string
...
export type CurvePoolsGqlQuery = {
  ...
  curvePools: Array<{
    ...
    baseAPY: number
    pageMetaData: { __typename?: 'PageMetaData'; title: string; description: string }
    lpTokenInfo: { __typename?: 'LpTokenInfo'; name: string; symbol: string }
    coingeckoInfo: { __typename?: 'CoingeckoInfo'; id: string; symbol: string }
    coins: Array<{
      __typename?: 'CurveCoin'
      symbol: string
      address: string
    ...
    underlyingCoins: Array<{ __typename?: 'CurveCoin'; ID: string; coingeckoId: string }>
    addresses: { __typename?: 'CurveAddresses'; swap: string; lpToken: string; gauge: string; deposit: string }
    rewards: { __typename?: 'CurveRewards'; rewardPtc: number; maxRewardPtc: number }
  }>
}
...
export type ProtocolGqlQuery = {
  ...
  protocol: {
    ...
    balance: any
    updatedAt: number
    tokenAddresses: Array<string | null>
    usdTvl: any
  }
}
...
export type TransactionLogEventsGqlQuery = {
  ...
  transactionLogEvents: Array<{
    ...
    decoded: {
      __typename?: 'LogEventDecoded'
      name: string
      params: Array<{ __typename?: 'LogEventParams'; name: string; type: string; value: string }>
    }
  }>
}
