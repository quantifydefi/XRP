...
export type GlobalStatsQueryGqlQuery = {
  __typename?: 'Query'
  globalStats: {
    __typename?: 'GlobalStats'
  ...
  protocols: Array<{ __typename?: 'Protocol'; name: string; symbol: string; id: string } | null | undefined>
}
...
export type AllProtocolsGqlQuery = {
  ...
  protocols: Array<
    | {
        ...
        geckoId: string
        category: string
        chains: Array<string | null | undefined>
        twitter: string
      }
    | null
    | undefined
...
export type CurvePoolsGqlQuery = {
  ...
  curvePools: Array<{
    ...
    coins: Array<{
      ...
      balance: string
      balanceUSD: number
      token?: { __typename?: 'CurveToken'; symbol: string; name: string; usdPrice: number } | null | undefined
    }>
  }>
}
...
export type AavePoolGqlQuery = {
  ...
  aavePools: Array<{
    ...
    price: { __typename?: 'AavePoolPrice'; id: string; priceInEth: string }
    addresses: {
      __typename?: 'AaveAddress'
...
export type BalancesGqlQuery = {
  ...
  balances: Array<{
    ...
    chainId: number
    pagination?: { __typename?: 'Pagination'; hasMore?: boolean | null | undefined } | null | undefined
    items: Array<{
      __typename?: 'BalanceItem'
      ...
      supportsErc?: Array<string> | null | undefined
      logoUrl: string
